...
import static org.yah.tools.jcuda.support.NVRTCSupport.check;
import static org.yah.tools.jcuda.support.NVRTCSupport.nvrtc;
...
public class CudaProgramBuilder {
    ...
    public CudaProgramPointer build() {
        ...
        LOGGER.info("building program {}", this);
